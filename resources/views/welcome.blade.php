          ...
          <ul class="movies-list  has-scrollbar">
              ...
              <div class="movie-card">
                ...
                <a href="./movie-details.html">
                  <figure class="card-banner">
                    <img src="{{ asset('images/upcoming-1.png') }}" alt="The Northman movie poster">
                  </figure>
                </a>
            ...
            <li>
              <div class="movie-card">
                ...
                <a href="./movie-details.html">
                  <figure class="card-banner">
                    <img src="{{ asset('images/upcoming-2.png') }}"
            ...
            <li>
              <div class="movie-card">
                ...
                <a href="./movie-details.html">
                  <figure class="card-banner">
                    <img src="{{ asset('images/upcoming-3.png') }}" alt="Memory movie poster">
                  </figure>
                </a>
            ...
            <li>
              <div class="movie-card">
                ...
                <a href="./movie-details.html">
                  <figure class="card-banner">
                    <img src="{{ asset('images/upcoming-4.png') }}"
      ...
      {{-- <section class="service">
        <div class="container">
          ...
          <div class="service-banner">
            <figure>
              <img src="{{ asset('images/service-banner.jpg') }}" alt="HD 4k resolution! only $3.99">
            </figure>
